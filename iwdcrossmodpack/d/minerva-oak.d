...
== L#OMB ~There are spirits of knowledge in Rashemen who study, and trickster spirits who fight as nimbly as you do. But I have never seen one who combines the strengths of both.~
...
== L#OMB ~Most spirits have more simplistic wishes. You would be... far too complicated for them.~
== BC0MMin ~I like being complicated. It's so boring being the same, each and every day.~
== L#OMB ~One day, I hope some of the spirits of my homeland meet you. They might be the ones who end up learning something.~
EXIT
...
== L#OMB ~And others do not find it strange?~
== BC0MMin ~Mmm, sometimes I get comments on it, but not that much. Most of the time, they think it's pretty.~
== L#OMB ~Hnh. You're lucky. There are few who would flatter my unique features.~
== BC0MMin ~Well, if it means anything, I think your antlers are quite cute.~
== L#OMB ~'Cute' isn't exactly how I want to be seen as. But I suppose it's better than wanting them cut off and mounted on a wall.~
EXIT